...
fn test_uri_dataspace_0(){
    ...
    assert_eq!(uri.dataspace.unwrap(), "/folder-name/project-name".to_string());
}
...
fn test_uri_data_object_0(){
    ...
    assert_eq!(uri.object_uuid.unwrap(), "2c0f6ef2-cc54-4104-8523-0f0fbaba3661");
...
fn test_uri_data_object_1(){
    ...
    assert_eq!(uri.object_uuid.unwrap(), "2c0f6ef2-cc54-4104-8523-0f0fbaba3661".to_string());
    assert_eq!(uri.object_version, None);
}
...
fn test_uri_data_object_2(){
    ...
    assert_eq!(uri.domain_version.unwrap(), "20".to_string());
    assert_eq!(uri.object_type.unwrap(), "obj_HorizonInterpretation".to_string());
    assert_eq!(uri.object_uuid.unwrap(), "421a7a05-033a-450d-bcef-051352023578".to_string());
...
fn test_find_uuid(){
    ...
    assert_eq!(find_uuid("my test TExt421a7a05-033a-450d-bcef-051352023578aa)"), "421a7a05-033a-450d-bcef-051352023578"
    );
}
...
fn test_complex_uri_0(){
    ...
    assert_eq!(uri.object_uuid.unwrap(), "ec8c3f16-1454-4f36-ae10-27d2a2680cf2".to_string());
...
fn test_complex_uri_2(){
    ...
    assert_eq!(uri.dataspace.unwrap(), "/folder-name/projectname".to_string());
    assert_eq!(uri.domain.unwrap(), "resqml".to_string());
    assert_eq!(uri.domain_version.unwrap(), "20".to_string());
    assert_eq!(uri.object_type.unwrap(), "obj_HorizonInterpretation".to_string());
    assert_eq!(uri.object_uuid.unwrap(), "421a7a05-033a-450d-bcef-051352023578".to_string());
...
fn test_complex_uri_3(){
    let uri = Uri::parse("eml:///witsml20.Channel(53b3bf2b-3aa3-458d-b40c-9a4cb754210e)/ChannelClass/Title");
   assert_eq!(uri.dataspace, None);
    assert_eq!(uri.domain.unwrap(), "witsml".to_string());
    assert_eq!(uri.domain_version.unwrap(), "20".to_string());
    assert_eq!(uri.object_type.unwrap(), "Channel".to_string());
    assert_eq!(uri.object_uuid.unwrap(), "53b3bf2b-3aa3-458d-b40c-9a4cb754210e".to_string());
    assert_eq!(uri.object_version, None);
    assert_eq!(uri.collection_domain, None);
    assert_eq!(uri.collection_domain_version, None);
    assert_eq!(uri.collection_type, None);
